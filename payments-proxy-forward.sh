...
echo "ssh -o ExitOnForwardFailure=yes -fN -R $REMOTE_PORT:localhost:$FR_DOCKER_PAYMENTS_HTTP_PORT"\
	"payments.fr-tech-dev"

ssh -o ExitOnForwardFailure=yes -fN -R $REMOTE_PORT:localhost:$FR_DOCKER_PAYMENTS_HTTP_PORT \
	payments.fr-tech-dev && \

...
$wgMemCachedServers = []; # see notes below
...
### TODO figure out what to do with this and other cache stuff, below.
# The following line is in staging setup. $hwgMemCachedServers
# is set on staging from /etc/. However it's production-specific and is
# not set anywhere in the testing settings. For now, leaving
# $wgMemCachedServers as an empty array, set in the auto-generated
# section above.
# $wgMemCachedServers = $hwgMemCachedServers;

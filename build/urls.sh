...
printf "\n"
printf "${GREEN}CiviCRM WMF URL:${RESET} https://wmf.localhost:$CIVICRM_PORT/civicrm\n"
printf "${GREEN}Civicrm WMF user/password:${RESET} admin/admin\n"
printf "\n"
...
printf "\n"
printf "${GREEN}Core Wiki URL:${RESET} https://localhost:$CORE_PORT\n"
printf "${GREEN}Core Wiki FundraisingWidgets URL:${RESET} https://localhost:$CORE_PORT/index.php/Special:FundraisingWidgets\n"
printf "\n"
...
printf "${LIGHT_BLUE}ComboWiki URL:${RESET} https://localhost:$PAYMENTS_PORT/index.php?title=Special:ComboWiki\n"
printf "\n"
...
printf "${GREEN}Fraud scoring service:${RESET} http://localhost:$FRAUD_SCORING_PORT/v1\n"
printf "\n"

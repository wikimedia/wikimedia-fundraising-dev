...
echo "Donut Central Notice URL: http://localhost:$FR_DOCKER_DONUT_HTTP_PORT/w/index.php?title=Special:UserLogin&returnto=Special:CentralNotice"
echo "Central Notice user/password: admin/$MW_PASSWORD"
